# Audio-To-Text_Converter   
A full-stack application built with Spring Boot, Java 25, and Google Gemini AI that transcribes both audio and video files into text.
